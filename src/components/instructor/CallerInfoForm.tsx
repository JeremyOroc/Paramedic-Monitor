    ...
    <section className="min-w-0 flex flex-col gap-3 border border-neutral-800 bg-neutral-950 p-4">
      ...
      {expanded ? (
        <div id="caller-info-editor" className="grid gap-3">
          <div
            data-testid="caller-info-title-countdown-row"
          ...
          <div className="grid gap-3 border border-neutral-800 bg-neutral-900/40 p-3">
            ...
            <div
              data-testid="caller-info-route-row"
              className="grid min-w-0 gap-3 md:grid-cols-2 md:items-end"
            >
              <AddressAutocomplete
                label="Start address"
              ...
              <div className="grid grid-cols-3 gap-3 text-xs font-bold uppercase tracking-wider">
                ...
                <span className="text-neutral-500">
                  ETA <span className="text-neutral-300">{dispatchEtaPreview}</span>
                </span>
              </div>
            </div>
          ...
          {visibleExtraFields.map(({ labelField, valueField, fallbackLabel }) => (
            <div
              key={valueField}
              data-testid="caller-info-extra-row"
              className="grid min-w-0 gap-3 border-t border-neutral-800 pt-3 md:grid-cols-2"
            >
              <label>
