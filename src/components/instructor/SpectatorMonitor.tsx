...
export function SpectatorMonitor({ projection, embedded = false }: SpectatorMonitorProps) {
  ...
  if (projection.model === 'wagamiA') {
    ...
    const projectedController: WagamiAWorkspaceController = {
      ...
      patientInfo: projection.patientInfo,
      patientInfoActions: [],
      ...
      openPatientInfo: noopState,
      closePatientInfo: noopState,
      decreasePatientAge: noopState,
      increasePatientAge: noopState,
      selectPatientSex: noopState,
