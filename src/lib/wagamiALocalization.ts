...
const COPY = {
  fr: {
    ...
    bpRead: 'Mesurer la pression artérielle', bpCancel: 'Annuler la mesure de pression artérielle', openPniSettings: 'Ouvrir les réglages PNI',
    heartRate: 'FC', bloodPressure: 'PNI', bpSys: 'PNI SYS', bpDia: 'PNI DIA',
    ...
    patientInfo: 'Info patient', patientInfoTitle: 'Informations patient', patientAge: 'Âge', patientSex: 'Sexe', done: 'Terminé', decreaseAge: 'Diminuer l’âge', increaseAge: 'Augmenter l’âge',
    twelveLeadTitle: 'ECG 12 dérivations', acquiring: 'ACQUISITION EN COURS', printPreview: 'Aperçu imprimé',
    etco2Title: 'Étalonnage EtCO₂', etco2Idle: 'Capteur non étalonné', etco2Calibrating: 'Étalonnage en cours', etco2Calibrated: 'Capteur étalonné', etco2CalibratingLane: 'ÉTALONNAGE…', etco2Cancelled: 'ANNULÉ', calibrate: 'Étalonner', cancel: 'Annuler',
    ...
    configureTitle: 'Configuration', patientModeLabel: 'Mode patient', pniSettings: 'Réglages PNI', vitalLogInterval: 'Intervalle du journal des signes vitaux',
    ...
    montrealDateTime: 'Date et heure de Montréal', monitorElapsedTimer: 'Temps écoulé du moniteur',
  ...
  en: {
    ...
    bpRead: 'Measure blood pressure', bpCancel: 'Cancel blood pressure measurement', openPniSettings: 'Open BP settings',
    heartRate: 'HR', bloodPressure: 'BP', bpSys: 'BP SYS', bpDia: 'BP DIA',
    ...
    mode: 'MODE', alarm: 'ALARM', alarmHr: 'HR', alarmSpo2: 'SpO₂', alarmBp: 'BP', ledNormal: 'Alarm LED normal', ledActive: 'Alarm LED active', ledDisabled: 'Alarm LED disabled',
    ...
    patientInfo: 'Patient Info', patientInfoTitle: 'Patient Information', patientAge: 'Age', patientSex: 'Sex', done: 'Done', decreaseAge: 'Decrease age', increaseAge: 'Increase age',
    twelveLeadTitle: '12-lead ECG', acquiring: 'ACQUIRING', printPreview: 'Print preview',
    etco2Title: 'EtCO₂ calibration', etco2Idle: 'Sensor not calibrated', etco2Calibrating: 'Calibration in progress', etco2Calibrated: 'Sensor calibrated', etco2CalibratingLane: 'CALIBRATING…', etco2Cancelled: 'CANCELLED', calibrate: 'Calibrate', cancel: 'Cancel',
    ...
    configureTitle: 'Configure', patientModeLabel: 'Patient mode', pniSettings: 'BP settings', vitalLogInterval: 'Vital Log interval',
    language: 'Device language', french: 'Français', english: 'English', alarmLed: 'Alarm LED', on: 'On', off: 'Off',
    pniTitle: 'BP settings', pniMode: 'Measurement mode', manual: 'Manual', automatic: 'Automatic', interval: 'Automatic interval', minutes: 'min',
    sent: 'SENT', transmissionTitle: 'Transmission destination',
    montrealDateTime: 'Montréal date and time', monitorElapsedTimer: 'Monitor elapsed time',
